<?php require_once __DIR__ . '/includes/functions.php'; $current_page = 'contact'; ?>
<!doctype html>
          ...
          <div class="row">
            <div class="col">
              <div class="pxn_page_header_content">
                <h1 class="page_title"><?= c('page_title', 'Contact Us') ?></h1>
...
<!-- start: Contact Page -->
        <div class="pxn-contact-page section-padding">
          <div class="container">
            <div class="row">
              <div class="col">
                <div class="pxn_contact_page_wrap">
                  <div class="section_heading text-center">
                    <span class="sec_sub"><?= c('contact_subtitle', 'Contact Us') ?></span>
                    <h2 class="sec_title"><?= c('contact_title', 'Let\'s Discuss How We Can Help You Succeed') ?></h2>
                  </div>

                  <div class="pxn_contact_page_form_wrap">
                    <div class="pxn_contact_map">
                      <div class="pxn-map"
                        data-map='{"lat":40.739157, "lng":-73.990929, "zoom":12, "icon":"pxni-map-pin"}'>
                      </div>
                    </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form_group">
                              ...
                              <input type="text" name="conName" id="fname" placeholder="Name...">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form_group">
                              <label for="email">Your Email*</label>
                              <input type="email" name="conEmail" id="email" placeholder="Email...">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form_group">
                              <label for="phone">Phone No</label>
                              <input type="tel" name="conPhone" id="phone" placeholder="Phone...">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form_group">
                              <label for="service">Choose a Option</label>
                              <select class="pxn-select" name="conService" id="service">
                          ...
                          <div class="col-12">
                            <div class="form_group">
                              ...
                              <textarea name="conMessage" id="message" placeholder="Message..."></textarea>
                            </div>
                          </div>
                          <div class="col-12">
                  ...
                  <div class="pxn_contact_page_info_wrap">
                    <div class="pxn_contact_info">
                      <div class="contact_icon">
                        <i class="pxni-phone"></i>
                      </div>
                      <div class="contact_content">
                        <span class="label">Have Question ?</span>
                        <a href="tel:+880123456789" class="text">Free +880 (123) 456 789</a>
                      </div>
                    </div>

                    <div class="pxn_contact_info">
                      <div class="contact_icon">
                        <i class="pxni-envelope-2"></i>
                      </div>
                      <div class="contact_content">
                        <span class="label">Write Email</span>
                        <a href="mailto:support@rovix.com" class="text">support@rovix.com</a>
                      </div>
                    </div>

                    <div class="pxn_contact_info">
                      <div class="contact_icon">
                        <i class="pxni-map-pin"></i>
                      </div>
                      <div class="contact_content">
                        <span class="label">Our Location</span>
                        <div class="text">123 Fifth Avenue, New York</div>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php endif; /* footer */ ?>
  ...
  <div class="modal" id="message_sent" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header border-0 rounded-0 alert alert-success" role="alert">
          <div class="modal-title fs-5 fw-bold">Message Sent Successfully</div>
  ...
  <div class="modal" id="message_fail" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header border-0 rounded-0 alert alert-danger" role="alert">
          <div class="modal-title fs-5 fw-bold">Error</div>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
