<?php require_once __DIR__ . '/includes/functions.php'; $current_page = 'pricing'; ?>
<!doctype html>
                  ...
                  <ul>
                    ...
                    <li class="has-dropdown current-menu-ancestor"><a href="#">Pages</a>
                      <ul class="sub-menu">
                        ...
                        <li class="current-menu-item"><a href="pricing.php">Pricing Page</a></li>
...
<!-- start: Pricing Section -->
        <section class="pxn-h1-pricing-section section-padding pricing-page">
          <div class="container">
            <div class="row">
              <div class="col">
