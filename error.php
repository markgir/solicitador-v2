<?php require_once __DIR__ . '/includes/functions.php'; $current_page = 'error'; ?>
<!doctype html>
                  ...
                  <ul>
                    ...
                    <li class="has-dropdown current-menu-ancestor"><a href="#">Pages</a>
                      <ul class="sub-menu">
                        ...
                        <li class="current-menu-item"><a href="error.php">Error 404</a></li>
...
<?php endif; /* page-header */ ?>
      ...
      <main id="content" class="site-main pxn-conetnt">
        ...
        <?php if (section_visible($current_page, 'error')): ?>
<!-- start: Error Page -->
        <div class="pxn-error-page section-padding">
          <div class="container">
            <div class="row">
              <div class="col">
                <div class="pxn_error_content_wrap text-center">
                  <div class="error_img">
