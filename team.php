<?php require_once __DIR__ . '/includes/functions.php'; $current_page = 'team'; ?>
<!doctype html>
                  ...
                  <ul>
                    ...
                    <li class="has-dropdown current-menu-ancestor"><a href="#">Pages</a>
                      <ul class="sub-menu">
                        ...
                        <li class="current-menu-item"><a href="team.php">Team</a></li>
              ...
              <div class="col">
                <div class="pxn-h2_team_wrap">
                  ...
                  <div class="team_wrapper">
                    ...
                    <div class="pxn-h1_team_member style-2">
